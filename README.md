...
**Skills:** `engineering`, `bug-triage`, `breakdown`, `converge`, `sasd-review`, `refinement`, `review-pr`, `pr-pickup`, `check-pr-approvals`, `verify-AC`, `visual-regression`, `intake-triage`, `my-triage`, `unit-test`
...
Don't try all 24 skills at once. Pick one that matches your role:
