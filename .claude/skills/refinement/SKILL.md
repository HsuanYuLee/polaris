...
|-------------|--------|-----------|------|
| `jira` | `refinement GT-478` | `{company_specs_dir}/{TICKET}/` + JIRA issue | 既有 JIRA-backed refinement；定版後寫 JIRA comment / label / description |
...
curl -s https://www.kkday.com/zh-tw/product/12156 | python3 check_jsonld_position.py
```
