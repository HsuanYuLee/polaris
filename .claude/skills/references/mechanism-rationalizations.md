...
|---------|--------|--------|
| `verification-evidence-required` | `scripts/verification-evidence-gate.sh` | `POLARIS_SKIP_EVIDENCE=1` |
| `quality-evidence-required` | `scripts/quality-gate.sh` | `POLARIS_SKIP_QUALITY=1` or `wip:` prefix |
