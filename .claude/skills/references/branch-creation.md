...
Format: `task/<TICKET>-<description>` (e.g. `task/TASK-3461-remove-presale-ab-test-logic`)
...
```text
develop -> feat/EPIC-478-cwv-js-bundle -> task/TASK-3711-dayjs-infra -> task/TASK-3900-products
```
...
```text
task/TASK-3820-nuxt-3-16-unhead-v2-upgrade -> feat/EPIC-495-homepage-structured-data -> task/TASK-3662-schema-locales-corporation
```

不要寫成 `develop -> task/TASK-3820-... -> ...`，否則 engineering 會把外部 branch 當作可 cascade rebase 的 owned branch。
