...
```
你要在 exampleco-b2c-web 修改 breadcrumb schema。
...
3. Local CI Mirror（engineer-delivery-flow § Step 2 — `ci-local.sh`）→ 行為驗證（engineer-delivery-flow Step 3）→ PR（engineering）
