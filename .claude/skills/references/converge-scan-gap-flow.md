...
| `CHANGES_REQUESTED` | PR has changes-requested review | `engineering` |
| `HAS_UNRESOLVED_COMMENTS` | PR has unresolved review comments | `engineering` |
...
2. Implementation: `NOT_STARTED`, `VERIFICATION_PENDING`
3. Planning: `NO_ESTIMATE`, `NO_BREAKDOWN`
4. Waiting / skipped: `REVIEW_STUCK`, `STALE_APPROVAL`, `WAITING_QA`,
   `WAITING_RELEASE`, `MERGE_CONFLICT`
