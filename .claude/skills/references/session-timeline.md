...
```jsonl
{"ts":"2026-04-02T14:30:00+08:00","event":"skill_invoked","skill":"work-on","ticket":"GT-500","branch":"task/GT-500-feature","outcome":"success","duration_s":180,"note":"implementation + PR opened"}
```
...
polaris-timeline.sh append --event skill_invoked --skill work-on \
  --ticket GT-500 --branch task/GT-500 --company kkday
