...
```jsonl
{"key":"plan-gap-missing-i18n-edge","type":"pitfall","content":"Breakdown missed i18n plural forms — AC only covered singular","confidence":7,"source":"EPIC-521 PR #2088","company":"exampleco","created":"2026-04-15","last_confirmed":"2026-04-15","tag":"plan-gap","metadata":{"subtag":"breakdown","ticket":"EPIC-521","pr_url":"https://github.com/example-org/b2c-web/pull/2088","reviewer_signal":"Reviewer pointed out plural forms break in zh-TW","gap_reason":"Breakdown AC template has no i18n pluralization check","classification":"plan_gap"}}
```
...
```jsonl
{"key":"review-lesson-server-route-error-handling","type":"pattern","content":"Nuxt server routes must return { statusCode, body } on error, not throw createError()","confidence":6,"source":"TASK-3788 PR #2102","company":"exampleco","created":"2026-04-15","last_confirmed":"2026-04-15","tag":"review-lesson","metadata":{"ticket":"TASK-3788","pr_url":"https://github.com/example-org/b2c-web/pull/2102","review_comment":"createError() in server routes causes unhandled rejection in production","lesson":"Nuxt server routes must return error objects, not throw createError()","repo":"example-org/b2c-web","file_path":"server/api/product/detail.ts"}}
```
