...
DP-183 後，root runtime toolchain 的入口是 bootstrap / doctor：

- `bash scripts/polaris-bootstrap.sh`
- `bash scripts/polaris-doctor.sh --profile core|runtime|delivery|full`
...
`polaris-bootstrap.sh`，只 echo command、記錄 audit，並讓使用者決定下一步。
