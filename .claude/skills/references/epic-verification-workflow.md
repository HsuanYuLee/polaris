...
| `url` | SIT 上的完整 URL | `https://sit-www.kkday.com/zh-tw/product/133300` |
...
├── GT-483/                  # Epic-specific fixtures
│   ├── proxy-config.yaml    # AI 生成的 proxy routing config
│   ├── dev.kkday.com.json   # 主要 fixture（錄製的 API responses）
