...
| Field | Example | Usage |
|-------|---------|-------|
| 來源 AC 驗收單 | `TASK-4001` | Link context, not re-verification |
| Epic | `EPIC-521` | Root for related work orders |
| **分析對象 branch** | `feat/EPIC-521-breadcrumblist-seo` | **Primary investigation surface — NOT develop/main** |
| Repos 涉入 | `exampleco-b2c-web, member-ci` | Scope of analysis |
| 相關 Task keys | `TASK-3800, TASK-3801` | Link to task.md work orders |
