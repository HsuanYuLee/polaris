...
cat > "$mapping" <<'JSON'
{
  "https://github.com/acme/acme-api/pull/10": {"thread_ts": "1776130982.981829"},
  "https://github.com/acme/acme-web/pull/20": {"thread_ts": "1776130982.981829"},
  "https://github.com/acme/acme-ios/pull/30": {"thread_ts": "1776130982.981829"}
}
JSON
