...
| Batch review execution | `review-inbox-batch-review-flow.md`, `review-pr/SKILL.md`, `repo-handbook.md` |
...
Slack channel scan 與 per-PR review 可以派 sub-agent；所有 dispatch 必須注入
...
7. 依 batch size / concurrency 分波派 per-PR review sub-agents。
