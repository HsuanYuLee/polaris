...
```bash
.claude/skills/memory-hygiene/scripts/memory-hygiene-tiering.py decay-scan --memory-dir "{memory_dir}"
```
...
```bash
.claude/skills/memory-hygiene/scripts/memory-hygiene-tiering.py dry-run --memory-dir "{memory_dir}"
```
