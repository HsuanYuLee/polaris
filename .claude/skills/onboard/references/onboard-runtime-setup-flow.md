...
`.claude/skills/onboard/scripts/polaris-env.sh` 與 engineering runtime verification 消費的 executable contract。
...
- `.claude/skills/onboard/scripts/onboard-doctor.sh`
- `.claude/skills/onboard/scripts/onboard-doctor-selftest.sh`
...
`.claude/skills/onboard/scripts/polaris-env.sh start <company> --project <repo>`
