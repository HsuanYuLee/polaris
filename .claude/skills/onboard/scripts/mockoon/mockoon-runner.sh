...
#
# Usage:
#   .claude/skills/onboard/scripts/mockoon/mockoon-runner.sh start <environments_dir> [--epic <name>] [--proxy]
#   .claude/skills/onboard/scripts/mockoon/mockoon-runner.sh stop
#   .claude/skills/onboard/scripts/mockoon/mockoon-runner.sh status
#
# Options:
