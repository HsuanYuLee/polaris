...
usage() {
  cat >&2 <<'EOF'
usage:
  .claude/skills/onboard/scripts/polaris-toolchain.sh install --required
  .claude/skills/onboard/scripts/polaris-toolchain.sh doctor --required [--json]
  .claude/skills/onboard/scripts/polaris-toolchain.sh run <capability.command>
  .claude/skills/onboard/scripts/polaris-toolchain.sh manifest [--required] [--json]
EOF
}
