...
Usage:
  python3 .claude/skills/learning/scripts/skill-sanitizer.py scan skill-name < SKILL.md
  python3 .claude/skills/learning/scripts/skill-sanitizer.py scan skill-name /path/to/SKILL.md
  python3 .claude/skills/learning/scripts/skill-sanitizer.py scan-dir /path/to/skills/
  python3 .claude/skills/learning/scripts/skill-sanitizer.py scan-memory /path/to/memory/
  python3 .claude/skills/learning/scripts/skill-sanitizer.py test
"""
