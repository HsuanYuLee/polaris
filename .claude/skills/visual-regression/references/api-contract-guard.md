...
- **`fixtures.mockoon` capability**: starts/stops Mockoon through `pnpm --filter polaris-toolchain mockoon:start` / `mockoon:stop`. Contract-check does NOT start Mockoon — it reads fixture files directly and hits live APIs
