...
- **`fixtures.mockoon` capability**: starts/stops Mockoon through `.claude/skills/visual-regression/scripts/polaris-toolchain.sh`. Contract-check does NOT start Mockoon — it reads fixture files directly and hits live APIs
