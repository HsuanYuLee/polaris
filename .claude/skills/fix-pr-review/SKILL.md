...
### 7b. Handbook Cross-Reference（衝突偵測）
...
|---------|------|
| **不衝突** | 正常進入 7c 判斷修正 |
| **衝突** | **暫停修正**，呈現給 user：「Reviewer 說 X，但 handbook 說 Y。(a) 修 code + 更新 handbook 配合 reviewer？(b) 回覆 reviewer 說明慣例？」|
| **Handbook 沒涵蓋** | 正常修正。修正後將新知識補進 handbook 子文件 |

**為什麼在修正前比對**：修正後才發現衝突 = 白做工。提前比對讓衝突成為 handbook 校正的機會。
