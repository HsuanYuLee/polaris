"""Structured validator authority extracted from scripts/validate-root-package-governance.sh."""
...
for name, command in scripts.items():
    ...
    if "\n" in command or "&&" in command or ";" in command:
        fail(
            f"package.json script {name!r} must remain a thin alias, not inline orchestration"
        )
