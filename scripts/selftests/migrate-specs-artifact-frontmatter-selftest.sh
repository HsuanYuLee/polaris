...
mkdir -p \
  ...
  "$specs/companies/exampleco/DEMO-567/artifacts/external-writes/20260513" \
...
cat >"$specs/companies/exampleco/DEMO-567/artifacts/external-writes/20260513/DEMO-567-jira-note-20260513.md" <<'MD'
## JIRA note
MD
