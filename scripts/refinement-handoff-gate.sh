...
Examples:
  refinement-handoff-gate.sh kkday/specs/GT-495
  refinement-handoff-gate.sh kkday/specs/GT-495/refinement.md
  refinement-handoff-gate.sh kkday/specs/GT-495/refinement.json
EOF
  exit 2
}
